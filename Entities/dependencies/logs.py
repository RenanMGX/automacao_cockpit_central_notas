...
class Logs:
    ...
    def __init__(self, name:str=PROJECT_NAME, *, path_folder:str=os.path.join(os.getcwd(), 'Logs'), hostname:str=Config()['log']['host'], port:str=Config()['log']['port'], token:str=Config()['log']['token']) -> None:
        name=PROJECT_NAME
